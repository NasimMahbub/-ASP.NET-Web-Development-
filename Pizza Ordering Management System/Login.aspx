            ...
            <tr>
                <td>
                    <asp:Image ID="Image3" runat="server" Height="150px" 
                        ImageUrl="images/reg1.jpg" Width="310px" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" Height="150px" 
                        ImageUrl="images/reg2.jpg" Width="310px" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Image ID="Image2" runat="server" Height="150px" 
                        ImageUrl="images/reg3.jpg" Width="310px" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Image ID="Image4" runat="server" Height="150px" 
                        ImageUrl="images/reg4.jpg" Width="310px" />
                </td>
            </tr>
                       ...
                       <tr>
                        ...
                        <tr>
                           ...
                           <td>
                                ...
                                <asp:CheckBox ID="CheckMe" runat="server" />
                           </td>
