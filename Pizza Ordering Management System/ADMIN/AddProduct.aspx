                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="drpcate" runat="server" CssClass="txt" 
                                ...
                                <asp:ListItem>CHESSE PIZZA</asp:ListItem>
                                <asp:ListItem>Veggie Pizza</asp:ListItem>
                                <asp:ListItem>Pepperoni Pizza</asp:ListItem>
                                <asp:ListItem>Meat Pizza</asp:ListItem>
                                <asp:ListItem>BBQ Chicken Pizza</asp:ListItem>
                                <asp:ListItem>Hawaiian Pizza</asp:ListItem>
                                <asp:ListItem>Maxican Spicy</asp:ListItem>
